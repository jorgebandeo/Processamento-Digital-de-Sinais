...
#define NSAMPLES 10 // Tamanho do filtro adaptativo
...
int main() {
    ...
    file_out_erro = fopen("..\\erro_Q2_VDSP.pcm", "wb");
    file_out_y = fopen("..\\saida_Q2_VDSP.pcm", "wb");
    ...
    printf("- erro_Q2_VDSP.pcm\n");
    printf("- saida_Q2_VDSP.pcm\n");
