...
int main() {
    ...
    int K = 100;                          // Tamanho do filtro adaptativo

    // Abrir arquivos
    file_x = fopen("..\\ruido_branco.pcm", "rb");
    file_d = fopen("..\\dn_Q1.pcm", "rb");
    file_out_erro = fopen("..\\erro_Q1_VDSP.pcm", "wb");
    file_out_y = fopen("..\\saida_Q1_VDSP.pcm", "wb");
    ...
    printf("- erro_Q1_VDSP.pcm\n");
    printf("- saida_Q1VDSP.pcm\n");
