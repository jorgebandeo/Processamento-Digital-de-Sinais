...
with open('questao_1/letra a/ruido_branco.pcm', 'rb') as fid:
    x = np.fromfile(fid, np.int16)

# Carregar Sinal Esperado (d[n])
with open('questao_1/letra a/dn_Q1.pcm', 'rb') as fid:
...
Ks = [100]  #valor minimo para tender a 0 - 100
...
for u in us:
    for K in Ks:
        ...
        # Salvar como imagem
        image_filename = f"questao_1/letra a/resultados_u{u:.1e}_K{K}.png"
